    ...
    Public Function ConsultaSUNAT(DATO As String, tipo As EnumTipoDato) As SunatEN
        ...
        Try
            If ValidarRUC(DATO, tipo, objE.mensaje) Then
                ...
                Return objsunat
                'If Not (DATA.Contains("El codigo ingresado es incorrecto") Or DATA.Contains("consultado no es válido")) Then
                ...
                '    objE.out_band = 0
                'Else
                '    objE.mensaje = "Error en el código captcha."
                '    If DATA.Contains("El codigo ingresado es incorrecto") Then
                '        objE.mensaje = "El codigo ingresado es incorrecto."
                '    End If
                '    If DATA.Contains("consultado no es válido") Then
                '        objE.mensaje = "El número de RUC consultado no es válido."
                '    End If
                '    objE.out_band = 1
                'End If
            Else
